...
int v8dbg_type_PromiseContainer__PROMISE_CONTAINER_TYPE = PROMISE_CONTAINER_TYPE;
...
int v8dbg_parent_ModuleInfo__FixedArray = 0;
int v8dbg_parent_ModuleInfoEntry__FixedArray = 0;
...
int v8dbg_parent_PromiseContainer__Struct = 0;
...
int v8dbg_class_PromiseContainer__thenable__JSReceiver = PromiseContainer::kThenableOffset;
int v8dbg_class_PromiseContainer__then__JSReceiver = PromiseContainer::kThenOffset;
int v8dbg_class_PromiseContainer__resolve__JSFunction = PromiseContainer::kResolveOffset;
int v8dbg_class_PromiseContainer__reject__JSFunction = PromiseContainer::kRejectOffset;
int v8dbg_class_PromiseContainer__before_debug_event__Object = PromiseContainer::kBeforeDebugEventOffset;
int v8dbg_class_PromiseContainer__after_debug_event__Object = PromiseContainer::kAfterDebugEventOffset;
...
int v8dbg_class_Module__flags__SMI = Module::kFlagsOffset;
int v8dbg_class_Module__embedder_data__Object = Module::kEmbedderDataOffset;
